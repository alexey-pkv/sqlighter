...
TEST(error_message, message_defined)
{
	...
	ASSERT_EQ(std::string::npos, sqlighter::error_message(SQLIGHTER_ERR_RESET).find(NDS));
	...
	ASSERT_EQ(std::string::npos, sqlighter::error_message(SQLIGHTER_ERR_EMPTY_QUERY).find(NDS));
	...
	ASSERT_EQ(std::string::npos, sqlighter::error_message(SQLIGHTER_ERR_CONNECTION_WAS_CLOSED).find(NDS));
	ASSERT_EQ(std::string::npos, sqlighter::error_message(SQLIGHTER_ERR_CONNECTION_ALREADY_OPEN).find(NDS));
